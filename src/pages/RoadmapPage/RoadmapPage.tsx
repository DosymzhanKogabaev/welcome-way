      ...
      <main className={styles.pageWrapper}>
        <div className={styles.roadmapContainer}>
          <div className={styles.topBlock}>
            ...
            <p className={styles.roadmapSubtitle}>We're glad to have you with us.</p>
              </div>
            <div className={styles.roadmapIntro}>
              ...
              <p>
                Our mission is to create a supportive environment where newcomers and
                locals work together to make integration smoother and kinder.
              </p>
            </div>
          </div>
            ...
            <div className={styles.roles}>
              <div className={styles.roleCard}>
               <div>
                ...
                <p>
                  Need help finding housing, a job, or getting local documents? Post a
                  request and someone from the community will reach out.
                </p></div>
              ...
              <div className={styles.roleCard}>
               <div> <h3 className={styles.roleTitle}>Volunteers</h3>
                <PiHandshakeFill className={styles.icon} />
                <p>
                  Want to offer guidance, translation, or just be a friendly voice?
                  Explore help requests and get involved.
                </p></div>
                <Link to="/asking-for-help" className={styles.cardButton}>
                  Offer Help
                </Link>
              ...
              <div className={styles.roleCard}>
                <div><h3 className={styles.roleTitle}>Local Residents</h3>
                <PiHouseLineFill className={styles.icon} />
                <p>
                  Your knowledge of the city and services is gold. Help newcomers settle
                  in and feel welcome.
                </p></div>
                <Link to="/asking-for-help" className={styles.cardButton}>
                  Help Locally
